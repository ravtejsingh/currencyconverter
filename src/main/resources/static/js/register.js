...
register.prototype.populateCountries = function(){
	if(this.countries.length > 0){
		this.countries.forEach(function(elem){
			var opt = elem;
...
register.prototype.dateTimeSetting = function(startYear, endYear){
...
//Countries
var country_list 
				= ["","Singapore","Afghanistan","Albania","Algeria","Andorra","Angola","Anguilla","Antigua and Barbuda","Argentina","Armenia","Aruba","Australia","Austria","Azerbaijan","Bahamas"
				...
				,"Sierra Leone","Slovakia","Slovenia","South Africa","South Korea","Spain","Sri Lanka","St Kitts and Nevis","St Lucia","St Vincent","St. Lucia","Sudan"
